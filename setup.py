...
setup(
    ...
    extras_require={
        "dev": [
            ...
            'pylint>=1.8', 'pytest==5.3.5', 'pytest-selenium-1.17.0',
    ...
    download_url='https://github.com/materialscloud-org/tools-barebone/archive/v{}.tar.gz'.
    format(version),
    keywords=[
        'tool', 'web tool', 'Materials Cloud'
    ],
    long_description=io.open(os.path.join(folder, 'README.md'),
                             encoding="utf-8").read(),
